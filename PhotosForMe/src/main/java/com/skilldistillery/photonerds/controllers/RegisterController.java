...
public class RegisterController {
		...
		public String registerAction(Model model, HttpSession session, String username, String password, String firstname, String lastname, String email,String role, String street, String street2, String city, String state, int postalcode, String phone) {
			...
			addr.setPhone(phone);
			newUser = userDAO.registerUser(newUser, addr);
